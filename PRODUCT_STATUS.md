...
| Home | Masterplan | Closed | `Masterplan.tsx` usa `masterplan.png` real (`/plans/masterplan.png`) en `.plan-real-image`; cards y mapa conservados | Si se regenera el PNG, mismo nombre de archivo | `5335f59` |
